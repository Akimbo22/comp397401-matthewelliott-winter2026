...
public class PostProcessingController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (timer > 2.5f)
        {
            ...
            {
                //colorAdjustmentsOverride.colorFilter.overrideState = true;
                //colorAdjustmentsOverride.colorFilter = new ColorParameter(poisonedColor);
        ...
        if (timer > 2.75f)
        {
            ...
            {
                //colorAdjustmentsOverride.colorFilter.overrideState = true;
                //colorAdjustmentsOverride.colorFilter = new ColorParameter(normalColor);
