...
public class FileDataService : IDataService
{
    ...
    public FileDataService(ISerializer serializer)
    {
        ...
        dataPath = Application.persistentDataPath; // C:/Users/<username>/AppData/LocalLow/
        fileExtension = ".json";
    }
    // GetPathFile - To combine the dataPaht, FileName and FileExtension
    ...
    public void Save(GameData data, bool overwrite = true)
    {
        ...
        if (!overwrite && File.Exists(fileLocation)) // Can't overwrite and file exists
        {
    ...
    public GameData Load(string fileName)
    {
        ...
        {
            throw new System.ArgumentException("No persistent data found at " + fileLocation);
        }
